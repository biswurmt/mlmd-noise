...
\begin{frame}{High-Level Architecture}
  ...
  \begin{tikzpicture}[
    ...
    \node[box, fill=symptom!60, below=of pkl] (pipe)
      {Patient Mapper\\{\tiny CSV enrichment}};
  ...
  the patient mapper for CSV enrichment.
\end{frame}
...
% ── Audit slide 1: pipeline overview ─────────────────────────────────────────
...
% ── Audit slide 2: evidence grounding + verification detail ───────────────────
