...
\begin{frame}{Research questions}
  \begin{enumerate}
    ...
    \item Can a knowledge-graph-grounded LLM pipeline reliably recover
          false-negative labels in a pediatric ED EHR, and does
          retraining on imputed labels improve recall?

    \item Does noise-robust meta-learning improve recall under
          asymmetric EHR label noise without requiring explicit
          noise annotations?

    \item Does combining label imputation with noise-robust training
          yield recall gains beyond either approach alone?
  \end{enumerate}
\end{frame}
