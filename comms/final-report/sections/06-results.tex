...
String matching requires negligible overhead (0.55 ms per encounter, 6.16 ms initialization). GraphRAG incurs higher cost (175.54 ms per encounter, 17.75 s initialization) but this latency is inconsequential for offline imputation. A phase-level breakdown separating entity matching from graph traversal is provided in Appendix~\ref{app:latency_benchmarks}.
