...
Adult Income (48,842 samples, 14 features) most closely matches the MLMD problem: mixed continuous and categorical features with moderate class imbalance. LiLAW improved PR-AUC by 1.3--2.9 percentage points across all four noise rates, with gains increasing monotonically (Table~\ref{tab:poc_adult}).
