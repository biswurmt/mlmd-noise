...
% [TODO: Confirm that the pre-split CSVs use these proportions. If a fixed calendar
%  cutoff was used instead, replace the proportions with explicit dates and counts.]
