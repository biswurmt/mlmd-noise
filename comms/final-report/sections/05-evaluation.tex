...
Conditions (1) and (2) isolate the effect of label correction; conditions (1) and (3) isolate the effect of noise-aware training; condition (4) versus (2) and (3) tests whether the two interventions provide complementary gains. Both pipeline components have been implemented and validated in isolation (Section~\ref{sec:results}); the integrated four-condition ablation on the full cohort is the immediate next evaluation step.
