\newpage
\section[Methods]{Methods\footnotemark}
\footnotetext{Access to the production codebase was granted late in the project timeline. Some experimental conditions described here were not completed in time; results are reported only where validation was fully executed.}
